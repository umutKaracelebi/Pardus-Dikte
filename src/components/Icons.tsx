export const MicIcon = ({ className = "w-6 h-6", glow = false }: {className?: string, glow?: boolean}) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`${className} ${glow ? 'drop-shadow-[0_0_8px_rgba(34,211,238,0.8)]' : ''}`}>
...
export const CpuIcon = ({ className = "w-5 h-5" }: {className?: string}) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
